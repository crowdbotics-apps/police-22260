"""police_22260 URL Configuration
...
admin.site.site_header = "Police"
admin.site.site_title = "Police Admin Portal"
admin.site.index_title = "Police Admin"

# swagger
api_info = openapi.Info(
    title="Police API",
    default_version="v1",
    description="API documentation for Police App",
)
